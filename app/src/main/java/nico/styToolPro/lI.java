...
public class lI implements IXposedHookLoadPackage
{

  public static final String QQ_PACKAGE_NAME = "com.tencent.mobileqq";
  private static final String WECHAT_PACKAGE_NAME = null;
  ...
  private void dohook(final XC_LoadPackage.LoadPackageParam loadPackageParam) throws Throwable
  {
	...
	if (TextUtils.isEmpty(qqVersion))
	{
	  ...
	  oOo.init(versionName);
	}

	findAndHookMethod("com.tencent.mobileqq.app.MessageHandlerUtils", loadPackageParam.classLoader, "a","com.tencent.mobileqq.app.QQAppInterface","com.tencent.mobileqq.data.MessageRecord", Boolean.TYPE, new XC_MethodHook() {
		@Override
	...
	findAndHookMethod("com.tencent.mobileqq.data.MessageForQQWalletMsg", loadPackageParam.classLoader, "doParse", new
	  XC_MethodHook() {
		...
		protected void afterHookedMethod(MethodHookParam param) throws Throwable
		{
		  ...
		  if (messageType == 6 && !oOoOo.password())
		  {
			return;
		  }
		  ...
		  Class qqplugin = findClass(oOo.QQPluginClass, walletClassLoader);
  ...
  public void handleLoadPackage(final XC_LoadPackage.LoadPackageParam loadPackageParam) throws Throwable
  {
	...
	{
	  findAndHookMethod("nico.styTool", loadPackageParam.classLoader, "onCreate", Bundle.class, new XC_MethodHook() {
		  @Override
		  protected void afterHookedMethod(MethodHookParam param) throws Throwable
		  {
			...
			if (activity != null)
			{
			  ...
			  if (intent != null)
			  {
				...
				if (!TextUtils.isEmpty(className) && className.equals("nico.styTool") && intent.hasExtra("donate"))
				{     
				}
			  }
			}
